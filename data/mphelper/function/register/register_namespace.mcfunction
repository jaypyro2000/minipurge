...
$execute if score #register_last variables matches 0 unless score #namespace_in_list variables matches 1 run data modify storage minipurge:variables namespaces append value $(namespace)