...
# Set up random number range low value as ground_y + min_agl
execute store result score #random_low variables run data get storage minipurge:variables sky_ground_y 1
execute store result score #min_agl variables run data get storage minipurge:variables min_agl 1
scoreboard players operation #random_low variables += #min_agl variables
execute store result storage minipurge:variables random_low int 1 run scoreboard players get #random_low variables

# Set up random number range high value as ground_y + max_agl
execute store result score #random_high variables run data get storage minipurge:variables sky_ground_y 1
execute store result score #max_agl variables run data get storage minipurge:variables max_agl 1
scoreboard players operation #random_high variables += #max_agl variables
...
execute store result score #sky_y variables run function mphelper:place/random/random_number with storage minipurge:variables
