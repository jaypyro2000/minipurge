...
execute store result storage minipurge:variables spawn_x_pos int 1 run function mphelper:random_loc/random_player_x_loc with storage minipurge:variables
execute store result storage minipurge:variables spawn_z_pos int 1 run function mphelper:random_loc/random_player_z_loc with storage minipurge:variables
