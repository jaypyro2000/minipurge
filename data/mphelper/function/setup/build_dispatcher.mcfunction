...
# Determines the structure to build and the height to build it at.
...
execute at @e[tag=ground_loc,limit=1] run function mphelper:setup/builder with storage minipurge:structure